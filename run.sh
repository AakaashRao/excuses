...
stata-mp -b do code/cleaning/exp2b-clean.do & 
stata-mp -b do code/cleaning/dictator-clean.do & 
python3 code/analysis/exp1-motive.py 
python3 code/analysis/exp1-motive-regression.py 
python3 code/analysis/purpose-prediction.py
Rscript code/analysis/exp1-analysis.R 
Rscript code/analysis/exp2-analysis.R 
Rscript code/analysis/exp2b-analysis.R 
Rscript code/analysis/dictator-analysis.R 
